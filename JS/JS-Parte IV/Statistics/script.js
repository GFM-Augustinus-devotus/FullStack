/*Em todos os casos será usado Arrow Functions */
...
/*------------------------Moda---------------------------*/
const moda = (...values) =>{
    // Preciso transformar o Array Unidimensional de numeros em um array de duas dimensões que mostra o valor e sua quantidade de ocorrências
    // [ [num,qtd] , [num,qtd], [num,qtd], [num,qtd]]
    ...
    qtd.sort((a,b) => b[1] - a[1]) /*Ordenando na Ordem Decrescente a partir da tupla na parte de quantidade de repetições */
    return qtd[0][0]
}

import { Vehicle ,  Car , Motocycle, calculateVehicleDepreciation as cd } from "./Vehicle.js"; 
...
console.log('-----------------------')
console.log(`Valor Atual ${myFirstCar.name} : R$ ${cd(myFirstCar, 1500)}`)
console.log(`Valor Atual ${myFirstMoto.name} : R$ ${cd(myFirstMoto, 1700)}`)
